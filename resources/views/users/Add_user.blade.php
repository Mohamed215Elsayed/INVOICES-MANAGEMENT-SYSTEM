...
@section('title')
اضافة مستخدم - أكاديمية الايمان للادارة القانونية
@stop
            ...
            <div class="card-body">
                ...
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                    ...
                    <div class="row mg-b-20">
                        ...
                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                            <label for="confirm-password"> تاكيد كلمة المرور: <span class="tx-danger">*</span></label>
                            <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper"
                    ...
                    <div class="row row-sm mg-b-20">
                        <div class="col-lg-6">
                            <label for="select-beast" class="form-label">حالة المستخدم</label>
                    ...
                    <div class="row mg-b-20">
                        <div class="col-xs-12 col-md-12">
                            <div class="form-group">
                                <label for="select-beast" class="form-label"> صلاحية المستخدم</label>
