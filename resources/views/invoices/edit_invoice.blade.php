                    ...
                    <form action="{{ route('invoices.update') }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="hidden" name="id_of_invoice_edit" value="{{ $invoices->id }}">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" id="inputName" name="invoice_Date" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ $invoices->invoice_Date }}" required>
                            </div>

                            <div class="col">
                                <label for="inputName" class="control-label">تاريخ الاستحقاق</label>
                                <input class="form-control fc-datepicker" id="inputName" name="Due_date" placeholder="YYYY-MM-DD"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="Section" class="form-control SlectBox" onkeydown="console.log($(this).val())"
