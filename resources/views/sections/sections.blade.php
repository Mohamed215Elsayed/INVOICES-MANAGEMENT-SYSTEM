...
<div class="row">
            ...
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    ...
                    <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-flip-horizontal"
                        data-toggle="modal" href="#modaldemo_add">اضافة قسم</a>
                    @endcan
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                        ...
                                        href="#exampleModal_edit" title="تعديل">
                                    ...
                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                        data-id="{{ $section->id }}" data-section_name="{{ $section->section_name }}"
                                        data-toggle="modal" href="#modaldemo_delete" title="حذف">
    ...
    {{-- =====================Add================== --}}
    <!-- Modal effects -->
    <div class="modal" id="modaldemo_add">
